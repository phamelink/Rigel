 ...
 *
 * TEXT SOURCE AND IMAGES: https://www.nasa.gov
...
public enum CelestialObjectInfo {
    SUN("Sun", "bodies/sun.jpg",
            "The Sun—the heart of our solar system—is a yellow dwarf star, a hot ball of glowing gases. Its " +
                    "gravity holds the solar system together, keeping everything from the biggest planets to the " +
                    "smallest particles of debris in its orbit. Electric currents in the Sun generate a magnetic " +
                    "field that is carried out through the solar system by the solar wind—a stream of electrically" +
                    " charged gas blowing outward from the Sun in all directions."),
    MOON("Moon", "bodies/moon.jpg",
            "The brightest and largest object in our night sky, the Moon makes Earth a more livable planet" +
                    " by moderating our home planet's wobble on its axis, leading to a relatively stable climate. It " +
                    "also causes tides, creating a rhythm that has guided humans for thousands of years. The Moon was " +
                    "likely formed after a Mars-sized body collided with Earth."),
    MERCURY("Mercury", "bodies/mercury.jpg",
            "The smallest planet in our solar system and nearest to the Sun, Mercury is only slightly " +
                    "larger than Earth's Moon. From the surface of Mercury, the Sun would appear more than three " +
                    "times as large as it does when viewed from Earth, and the sunlight would be as much as seven " +
                    "times brighter. Despite its proximity to the Sun, Mercury is not the hottest planet in our solar " +
                    "system – that title belongs to nearby Venus, thanks to its dense atmosphere."),
    VENUS("Venus", "bodies/venus.jpg",
            "Second planet from the Sun and our closest planetary neighbor, Venus is similar in structure " +
                    "and size to Earth, but it is now a very different world. Venus spins slowly in the opposite" +
                    " direction most planets do. Its thick atmosphere traps heat in a runaway greenhouse effect," +
                    " making it the hottest planet in our solar system—with surface temperatures hot enough to melt" +
                    " lead. Glimpses below the clouds reveal volcanoes and deformed mountains."),
    MARS("Mars", "bodies/mars.jpg",
    ...
    SATURN("Saturn", "bodies/saturn.png",
            "Saturn is the sixth planet from the Sun and the second largest planet in our solar system." +
                    ...
                    " the only planet to have rings—made of chunks of ice and rock—but none are as spectacular or" +
                    " as complicated as Saturn's. Like fellow gas giant Jupiter, Saturn is a massive ball made" +
    ...
    NEPTUNE("Neptune", "bodies/neptune.jpg",
            "Dark, cold and whipped by supersonic winds, ice giant Neptune is the eighth and most " +
                    ...
                    " is the only planet in our solar system not visible to the naked eye and the first predicted" +
                    " by mathematics before its discovery. In 2011 Neptune completed its first 165-year orbit since" +
